...
import tech.catenate.orchestra.service.CorsoService;
import tech.catenate.orchestra.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link tech.catenate.orchestra.domain.Corso}.
 */
@RestController
@RequestMapping("/api/corsos")
public class CorsoResource {
    ...
    public ResponseEntity<Corso> createCorso(@RequestBody Corso corso) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/corsos/" + corso.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, corso.getId().toString()))
            .body(corso);
    }
    ...
    public ResponseEntity<Corso> updateCorso(@PathVariable(value = "id", required = false) final Long id, @RequestBody Corso corso)
        ...
        corso = corsoService.update(corso);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Corso> getCorso(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteCorso(@PathVariable("id") Long id) {
