...
/**
 * REST controller for managing {@link tech.catenate.orchestra.domain.InsegnanteCorso}.
 */
@RestController
@RequestMapping("/api/insegnante-corsos")
public class InsegnanteCorsoResource {
    ...
    public ResponseEntity<InsegnanteCorso> createInsegnanteCorso(@RequestBody InsegnanteCorso insegnanteCorso) throws URISyntaxException {
        ...
        insegnanteCorso = insegnanteCorsoService.save(insegnanteCorso);
        return ResponseEntity.created(new URI("/api/insegnante-corsos/" + insegnanteCorso.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, insegnanteCorso.getId().toString()))
            .body(insegnanteCorso);
    }
    ...
    public ResponseEntity<InsegnanteCorso> updateInsegnanteCorso(
        ...
        insegnanteCorso = insegnanteCorsoService.update(insegnanteCorso);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<InsegnanteCorso> getInsegnanteCorso(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteInsegnanteCorso(@PathVariable("id") Long id) {
