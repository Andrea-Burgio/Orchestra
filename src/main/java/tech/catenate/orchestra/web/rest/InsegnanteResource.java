...
import tech.catenate.orchestra.service.InsegnanteService;
import tech.catenate.orchestra.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link tech.catenate.orchestra.domain.Insegnante}.
 */
@RestController
@RequestMapping("/api/insegnantes")
public class InsegnanteResource {
    ...
    public ResponseEntity<Insegnante> createInsegnante(@RequestBody Insegnante insegnante) throws URISyntaxException {
        ...
        insegnante = insegnanteService.save(insegnante);
        return ResponseEntity.created(new URI("/api/insegnantes/" + insegnante.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, insegnante.getId().toString()))
            .body(insegnante);
    }
    ...
    public ResponseEntity<Insegnante> updateInsegnante(
        ...
        insegnante = insegnanteService.update(insegnante);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Insegnante> getInsegnante(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteInsegnante(@PathVariable("id") Long id) {
